...
from dash import dcc, html, Input, Output, ctx, ALL, callback
from dashboard_components import figures_components
import random
import dash


dash.register_page(__name__, path='/pivot_table')
...
def pivot_table(pivot_button, pivot_table_values, pivot_table_columns, pivot_table_index, pivot_table_aggfunc,
    ...
    if ctx.triggered_id == 'pivot-table-button':
        dash_pivot_table, dash_pivot_chart = figures_components.create_pivot_table(pivot_table_values,
