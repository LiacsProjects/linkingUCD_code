...
CREATE TABLE IF NOT EXISTS `lucd_reduced`.`person` (
  ...
  `TypeOfPerson_fk` INT NULL DEFAULT NULL,
  PRIMARY KEY (`PersonID`),
  INDEX `TypeOfPerson_idx` (`TypeOfPerson_fk` ASC) VISIBLE,
  CONSTRAINT `TypeOfPerson_person`
    FOREIGN KEY (`TypeOfPerson_fk`)
...
-- -----------------------------------------------------
-- Table `lucd_reduced`.`person_to_person`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lucd_reduced`.`person_to_person` (
  `PersonToPersonID` INT NOT NULL AUTO_INCREMENT,
  `FromPersonID` INT NOT NULL,
  `ToPersonID` INT NOT NULL,
  `TypeOfRelation` INT NOT NULL,
  PRIMARY KEY (`PersonToPersonID`),
