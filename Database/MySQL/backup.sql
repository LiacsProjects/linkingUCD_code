...
-- -----------------------------------------------------
-- Table `LUCD_schema`.`Paper`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LUCD_schema`.`Paper` (
...
CREATE TABLE IF NOT EXISTS `LUCD_schema`.`Experiment` (
  ...
  CONSTRAINT `fk_Experiment_Paper2`
    ...
    REFERENCES `LUCD_schema`.`Paper` (`PaperID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `LUCD_schema`.`Presitgous people`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LUCD_schema`.`Presitgous people` (
...
-- -----------------------------------------------------
-- Table `LUCD_schema`.`Paper_has_Person`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LUCD_schema`.`Paper_has_Person` (
...
-- -----------------------------------------------------
-- Table `LUCD_schema`.`Person_Is_Father`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LUCD_schema`.`Person_Is_Father` (
  `Person_idPerson` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `LUCD_schema`.`Person_Is_Mother`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LUCD_schema`.`Person_Is_Mother` (
  `Person_idPerson` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `LUCD_schema`.`Person_has_Child`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LUCD_schema`.`Person_has_Child` (
  `Person_idPerson` INT NOT NULL,
  ...
  CONSTRAINT `fk_Person_has_Child_Child1`
    ...
    REFERENCES `LUCD_schema`.`Child` (`ChildID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
